        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading" id="tab-name">吉他谱</div>
            ...
            <div class="col-md-3">
                <div class="panel panel-default ">
                    <div class="panel-heading">用到的和弦</div>
                    <div class="panel-body">
...
@section('foot')
    ...
    <script type="text/javascript">
        ...
        if (id != null) {
            $.get("/tab/" + id, function (result) {
                //TODO 处理曲谱内容

                $('#tab-name').html(result.tab_name + "(" + result.singer_name + ")");
                ...
                $('rt').each(function (index) {
                    ...
                    if (chordArr.indexOf(c) < 0) {
                        chordArr.push(c);
                    }

                });

                var chordStr = chordArr.join(",");

                $.ajax({
                    url: '/chord?names=' + chordStr,
                    type: "GET",
                    success: function (result) {
                        ...
                        for (var i in result) {
                            ...
                            var canvas = $('<canvas>').attr({
                                ...
                                height: height + 25,//TODO magicnumber
                                width: width + 40
                            });
